...
The [`implieds.csv`](./data/implieds.csv) is a list of legislative repository's licenses, a demand motivated by the [GODI/legislation datasets](http://index.okfn.org/dataset/legislation/), and an in-progress work. Each *implied license* need a report, like [implied-lex-BR-v1](https://github.com/ppKrauss/openCoherence2/blob/master/reports/implied-lex-BR-v1.md) or  [implied-berne-v1971](https://github.com/ppKrauss/openCoherence2/blob/master/reports/implied-berne-v1971.md).
